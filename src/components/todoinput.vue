...
<style scoped>
    ...
    .addContainer {border-style: none; float: right; background: linear-gradient(to right, #6478fb,#8763fb); display: inline-block; width: 3rem; height: 50px; border-radius: 0 5px 5px 0; color: #fff;}
</style>